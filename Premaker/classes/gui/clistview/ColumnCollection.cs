...
namespace com.jds.Premaker.classes.gui.clistview
{
    ...
    public class CColumn
    {
        ...
        public Control ActivatedEmbeddedControlTemplate { get; set; }
        ...
        {
            get { return m_ActivatedEmbeddedType; }
            set
            {
                ...
                {
                    ActivatedEmbeddedControlTemplate = new CTextBox();
                }
                else if (value == GLActivatedEmbeddedTypes.ComboBox)
                {
                    ActivatedEmbeddedControlTemplate = new CComboBox();
                }
                else if (value == GLActivatedEmbeddedTypes.DateTimePicker)
                {
                    ActivatedEmbeddedControlTemplate = new CDateTimePicker();
                }
                else if (value == GLActivatedEmbeddedTypes.None)
                {
                    ActivatedEmbeddedControlTemplate = null;
                }
        ...
        /// </summary>
        [Description("When sort turned on, only compare numeric values in cells."), Category("Behavior"),
         Browsable(true)]
        ...
        ///   pointer to parent
        /// </summary>
        [Description("Parent"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
         Browsable(false)]
        ...
        /// </summary>
        [Description("Whether or not checkboxes are visible in this column."), Category("Behavior"), Browsable(true)]
            ...
            set
            {
                if (m_nWidth != value)
                {
                    ...
                    if (ChangedEvent != null)
                        ChangedEvent(this, new ChangedEventArgs(ChangedTypes.ColumnChanged, this, null, null));
        ...
        public ColumnStates State
        {
            ...
            set
            {
                if (m_State != value)
                {
                    m_State = value;
                    if (ChangedEvent != null)
                        ChangedEvent(this, new ChangedEventArgs(ChangedTypes.ColumnStateChanged, this, null, null));
                    // fire the column clicked event
                }
            }
        }
    ...
    public class GLColumnCollection : CollectionBase
    {
        ...
        ///   pointer to parent
        /// </summary>
        [Description("Parent"), Browsable(false)]
        public CListView Parent { get; set; }
        ...
        ///   Indexer
        /// </summary>
        public CColumn this[int nColumnIndex]
        {
            get { return List[nColumnIndex] as CColumn; }
        }
        ...
        /// </summary>
        public CColumn this[string strColumnName]
        {
            get
            {
                return (CColumn)List[GetColumnIndex(strColumnName)];
                // make sure the column is seeded with which one it is before we call it
            }
        }
        ...
        public CColumn Add(string strColumnName, int nColumnWidth)
        {
        ...
        {
            if ((nColumnIndex >= Count) || (nColumnIndex < 0))
                return; // error

            List.RemoveAt(nColumnIndex);

            if (ChangedEvent != null)
                ChangedEvent(this, new ChangedEventArgs(ChangedTypes.ColumnCollectionChanged, null, null, null));
            // fire the column clicked event
        }
        ...
        {
            foreach (CColumn column in List)
    ...
    internal class CustomCollectionEditor : CollectionEditor
    {
        ...
        protected override object CreateInstance(Type itemType)
        {
            ...
            do
            {
                strTmpColName = "Column" + m_nUnique;
                cols = GetItems(strTmpColName);
            ...
            ((CColumn)col).Name = strTmpColName;
