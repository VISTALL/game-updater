...
namespace com.jds.AWLauncher.classes.date
{
    /// <summary>
    ...
    public class Rfc822DateTime
    {
        ...
        public static DateTime Parse(string s)
        {
            ...
            else
            {
                throw new FormatException(String.Format(null,
                                                        "{0} is not a valid RFC 822 string representation of a date and time.",
                                                        s));
            }
        }
        ...
        public static string ToString(DateTime utcDateTime)
        {
            ...
            return utcDateTime.ToString(Rfc822DateTimeFormat, DateTimeFormatInfo.InvariantInfo);
        }
        ...
        public static bool TryParse(string s, out DateTime result)
        {
            ...
            if (!String.IsNullOrEmpty(s))
            {
                ...
                if (DateTime.TryParseExact(ConvertZoneToLocalDifferential(s), Rfc822DateTimePatterns,
